...
<body class="h-full flex flex-col font-sans antialiased text-gray-200"> {{-- Warna Teks Umum Putih/Abu-abu Terang --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    <a href="/home"
                        class="text-gray-300 hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">Home</a>
                    <a href="/about"
    ...
    <footer class="bg-gray-950 text-gray-400 py-6 mt-auto border-t border-blue-600/50"> {{-- Footer Paling Gelap --}}
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-sm">&copy; {{ date('Y') }} Commander Analytics. All rights reserved.</p>
            {{-- Ganti Nama Footer --}}
